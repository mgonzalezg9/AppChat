...
public class RegisterWindow extends JFrame {
	...
	public RegisterWindow() {
		...
		lblNewLabel.setIcon(new ImageIcon(RegisterWindow.class.getResource("/images/user.png")));
		panel.add(lblNewLabel);
		
		JPanel panel_1 = new JPanel();
		contentPane.add(panel_1, BorderLayout.SOUTH);
		GridBagLayout gbl_panel_1 = new GridBagLayout();
		gbl_panel_1.columnWidths = new int[]{0, 0, 60, 60, 10, 0, 60, 60, 10, 0};
		gbl_panel_1.rowHeights = new int[]{0, 0, 0, 0, 0, 10, 0};
		...
		JLabel lblNewLabel_5 = new JLabel("Have an account?");
		...
		gbl_panel_2.columnWidths = new int[]{10, 0, 60, 60, 10, 0};
		gbl_panel_2.rowHeights = new int[]{10, 0, 0, 0, 10, 0};
